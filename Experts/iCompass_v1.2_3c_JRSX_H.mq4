...
void OnTick()
  {
   ...
   //Baseline
   double ICompassUP = iCustom(NULL, 0, "iCompass_v1.2", BarsCount, MAperiods, ShiftBars, 0, 1);
   double ICompassDN = iCustom(NULL, 0, "iCompass_v1.2", BarsCount, MAperiods, ShiftBars, 1, 1);
   ...
   {  
      ...
      {
         if(ClosePrice > ICompassUP || ClosePrice > ICompassDN)
         {
