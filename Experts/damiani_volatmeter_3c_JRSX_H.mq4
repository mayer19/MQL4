...
void OnTick()
  {
   ...
   //volume damiani
   double damiani0 = iCustom(NULL, 0, "damiani_volatmeter", Viscosity, Sedimentation, Threshold_level, 0, Shift);
   double damiani1 = iCustom(NULL, 0, "damiani_volatmeter", Viscosity, Sedimentation, Threshold_level, 1, Shift);
   double damiani2 = iCustom(NULL, 0, "damiani_volatmeter", Viscosity, Sedimentation, Threshold_level, 2, Shift);   
